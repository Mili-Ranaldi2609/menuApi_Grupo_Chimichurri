...
const DetalleSucursal: React.FC<DetalleSucursalProps> = ({ sucursal, onClose }) => {
  return (
    <div className="detalle-modal">
      ...
      <p>Domcilio: {sucursal.domicilio.calle} {sucursal.domicilio.numero}, {sucursal.domicilio.cp}
        {sucursal.domicilio.localidad.nombre},  {sucursal.domicilio.localidad.provincia.nombre}
      </p>
