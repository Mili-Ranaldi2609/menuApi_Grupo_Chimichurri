...
interface SucursalModalProps {
    ...
    empresa:IEmpresa2 | undefined // ID de la empresa a la que pertenece la sucursal
...
const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const handleSubmit =  async () => {
        ...
        try {
            ...
            if (sucursal) {
                // Si estamos editando
                 await sucursalService.updateSucursalById(sucursal.id,formData,activeEmpresa);
            } else {
                
                 await sucursalService.createSucursalByEmpresa(formData, activeEmpresa);
